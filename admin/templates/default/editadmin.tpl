{if $logged_in}
    ...
    {* Location Links *}
    <span class="location">&nbsp;&nbsp;<a href="main.php">{$lang.admin_home}</a> / <a href="admins.php">{$lang.admins_nav_admin_accounts}</a> / <a href="manageadmin.php?id={$user_details[db].id}">{$lang.manageadmin_nav_manage_admin}</a> / {$lang.editadmin_nav_edit_account}</span>
    ...
    <form action="editadmin.php?id={$user_details[db].id}" method="post">
    <table border="0" cellpadding="1" cellspacing="0" width="400" align="center" class="tablez">
      <tr class="table_title" height="20">
        <td align="center" colspan="2">{$lang.editadmin_nav_edit_account}</td>
      </tr>
