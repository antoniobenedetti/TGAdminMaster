{if $logged_in}
    ...
    {* Location Links *}
    <span class="location">&nbsp;&nbsp;<a href="main.php">{$lang.admin_home}</a> / <a href="tickets.php">{$lang.tickets_title}</a> / {$lang.viewticket_title}</span>
    ...
    <table border="0" cellpadding="2" cellspacing="0" width="550" align="center" class="tablez">
      ...
      <tr>
        <td colspan="2" align="center"><b>{$lang.private_notes}:</b></td>
      </tr>
      
      <tr>
        <td colspan="2" align="center" height="80"><textarea name="notes" id="notes" class="ticket_notes">{$ticket_orig[orig].internal_notes|stripslashes}</textarea></td>
      </tr>
