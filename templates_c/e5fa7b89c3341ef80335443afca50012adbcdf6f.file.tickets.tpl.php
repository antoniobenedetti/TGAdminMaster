<?php /* Smarty version Smarty-3.1.11, created on 2012-09-20 16:53:40
         compiled from ".\templates\default\tickets.tpl" */ ?>
<?php /*%%SmartyHeaderCode:203505b2df4bafdc9-56338352%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '203505b2df4bafdc9-56338352',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_505b2df4d2e271_51148791',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_505b2df4d2e271_51148791')) {function content_505b2df4d2e271_51148791($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['logged_in']->value){?>
...
'" onMouseOver="style.cursor='pointer' ; this.style.backgroundColor='#c3c3c3'" onMouseOut=style.cursor='auto';this.style.backgroundColor='<?php if ((1 & $_smarty_tpl->getVariable('smarty')->value['section']['db']['iteration'])){?>#e1e1e1<?php }else{ ?>#d7d7d7<?php }?>'>
            ...
            <td align="left"><b>
              <?php if (strlen($_smarty_tpl->tpl_vars['tickets']->value[$_smarty_tpl->getVariable('smarty')->value['section']['db']['index']]['subject'])>30){?>
                <?php echo substr(stripslashes($_smarty_tpl->tpl_vars['tickets']->value[$_smarty_tpl->getVariable('smarty')->value['section']['db']['index']]['subject']),0,25);?>
 ...
              <?php }else{ ?>
